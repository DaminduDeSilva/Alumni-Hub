    ...
    <footer className="bg-primary border-t border-primary-dark text-white pt-12 pb-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-xl font-headings font-bold tracking-wide">
                Alumni Hub
              </span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Connecting generations of engineering excellence. A central platform for networking, events, and professional growth.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/directory" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Alumni Directory
                </Link>
              </li>
              <li>
                <Link to="/my-profile" className="text-gray-300 hover:text-white transition-colors text-sm">
                  My Profile
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start text-sm text-gray-300">
                <svg className="w-5 h-5 mr-2 text-secondary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span>University of Engineering,<br />Colombo, Sri Lanka</span>
              </li>
              <li className="flex items-center text-sm text-gray-300">
                <svg className="w-5 h-5 mr-2 text-secondary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>admin@alumni-hub.edu</span>
              </li>
              <li className="flex items-center text-sm text-gray-300">
                <svg className="w-5 h-5 mr-2 text-secondary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>© {currentYear} Alumni Hub. All rights reserved.</p>
